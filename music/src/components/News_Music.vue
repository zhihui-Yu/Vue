<template>
  <div class="mod-albums">
    <div class="hd log url">
      <h2>新歌速递</h2>
      <router-link :to="{name:'morelist',params:{moreType:this.type,title:title}}" tag="div">
        更多
      </router-link>
    </div>
    <div class="container">
      <div class="gallery">
        <div class="scroller">
          <router-link tag="div" :to="{name:'musicplay',params:{songid:item.song_id}}"  class="card url" v-for="(item,index) in News_Music" :key="index">
            <div class="album">
...
<script>
    export default {
        ...
        mounted() {
            ...
            this.$axios.get(url)
                .then(res => {
                    this.News_Music = res.data.song_list
